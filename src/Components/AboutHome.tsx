...
const AboutHome = () => {
	...
	return (
		<div
			className="flex justify-center items-center min-h-[60vh] shadow-about-home bg-fixed bg-cover bg-center py-7 md:py-0"
			style={{ backgroundImage: `url(${background})` }}
		>
			<div className="bg-tertiary w-4/5 text-gray-100 font-poppins p-8 rounded-lg">
